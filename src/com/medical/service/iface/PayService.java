...
public interface PayService {
	 ...
	 * @return: String
	 */
	String updateAlipayRecordToCreat(Integer senderid, String sendername, BigDecimal totalAmount, Integer receiveid,
			String receivename, Integer orderid, Integer ordertype, Integer type, String outtradeno) throws Exception;
	 ...
	 * @return: String
	 */
	String updateAlipayRecordToFinish(String out_trade_no, Integer payid, String trade_no, String buyer_logon_id,
			String seller_email, String info, BigDecimal receiptamount, Integer stateid) throws Exception;

	/**
	 * @Title: updateAlipayRecordToCancle
	 * @Description: TODO
	 * @param out_trade_no 本地生成的订单号
	 * @param payid 支付id 
	 * @param trade_no 支付宝单号
