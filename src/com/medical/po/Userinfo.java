...
public class Userinfo {
    ...
    private String useradrarea;

    private String useradrother;
    ...
    public String getUseradrprovince() {
        return useradrprovince;
    }

    public void setUseradrprovince(String useradrprovince) {
        this.useradrprovince = useradrprovince == null ? null : useradrprovince.trim();
    }
    ...
    public void setUseradrcity(String useradrcity) {
        this.useradrcity = useradrcity == null ? null : useradrcity.trim();
    }

    public String getUseradrarea() {
        return useradrarea;
    }

    public void setUseradrarea(String useradrarea) {
        this.useradrarea = useradrarea == null ? null : useradrarea.trim();
    }

    public String getUseradrother() {
        return useradrother;
    }

    public void setUseradrother(String useradrother) {
        this.useradrother = useradrother == null ? null : useradrother.trim();
    }
